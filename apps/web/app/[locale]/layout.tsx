...
const APP_URL = process.env.NEXT_PUBLIC_APP_URL || "https://agentforge.community";

export const metadata: Metadata = {
  title: {
    default: "AgentForge — The EU-First Marketplace for AI Agent Tools",
  ...
  openGraph: {
    type: "website",
    siteName: "AgentForge",
    title: "AgentForge — Where AI Agents Find Their Tools",
    description:
      "The EU-first marketplace for MCP tool servers. 10+ servers, 30+ tools, ready for your AI agents.",
    images: [{ url: "/api/og", width: 1200, height: 630, alt: "AgentForge" }],
  },
  twitter: {
